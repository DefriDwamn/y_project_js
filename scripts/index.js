...
function createCard(link, name) {
  const curCard = cardTemplate.querySelector('.places__item').cloneNode(true);
  curCard.querySelector('.card__image').src = link;
  curCard.querySelector('.card__description').querySelector('.card__title').textContent = name;
